function cal(){
    let opr1 =document.getElementById("input1").value;
    let opr2 = document.getElementById("input2").value;
    let opr =document.getElementById("opr").value;
    if(opr=="+"){
        let res = parseInt(opr1)  + parseInt(opr2)
...
// let input1 = document.getElementById("textval");
